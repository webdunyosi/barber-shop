...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-zinc-900/95 backdrop-blur-lg border-r border-emerald-500/30 min-h-screen sticky top-0">
      <div className="p-6">
        {/* Logo Section */}
        <div className="flex items-center gap-3 mb-8 pb-6 border-b border-emerald-500/30">
          <img className="w-12 h-12 rounded-lg" src="/logo.png" alt="Logo" />
          <div>
            <h2 className="text-lg font-bold text-white uppercase">Web Barber</h2>
            <p className="text-xs text-emerald-500">Menu</p>
          </div>
        </div>

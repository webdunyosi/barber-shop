  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-800/70 border border-green-500/50 rounded-2xl shadow-2xl max-w-md w-full p-8 animate-bounce-in backdrop-blur-md relative">
        ...
        {/* Booking Details */}
        <div className="bg-zinc-900/50 border border-white/10 rounded-lg p-6 mb-6 space-y-3">
        ...
        <button
          onClick={onClose}
          className="w-full bg-emerald-500 text-white py-3 rounded-lg font-semibold hover:bg-emerald-600 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/50"
        >
          Yaxshi
        </button>
      </div>
